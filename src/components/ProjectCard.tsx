...
export default function ProjectCard({
  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-700 dark:to-slate-600 border-b border-slate-200/60 dark:border-slate-600/30">
        {/* Browser Chrome */}
        <div className="flex items-center gap-2 px-4 py-3 bg-slate-200/80 dark:bg-slate-700/80 border-b border-slate-300/40 dark:border-slate-600/40">
          ...
          <div className="flex-1 mx-4">
            <div className="h-5 rounded-md bg-white/60 dark:bg-slate-500/40 border border-slate-300/40 dark:border-slate-600/40 flex items-center px-3">
        ...
        <div className="flex items-center justify-center h-32">
          <div className="p-4 rounded-2xl bg-white/60 dark:bg-slate-600/40 backdrop-blur-sm">
